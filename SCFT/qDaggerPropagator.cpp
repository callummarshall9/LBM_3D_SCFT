...
qDaggerPropagator::qDaggerPropagator(int nx, int ny, int nz, std::string velocity_set, double c_s, std::string boundary_condition, double gamma_dot, double N, int N_s, double box_length_rg, std::string field_type, double f, double chiN, double* w_A, double* w_B):
